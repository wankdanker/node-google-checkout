var assert = require('assert'),
	...
	utils = require('./lib/utils'), //this module is not publicly available
	request = require('request')
	xml2js = require('xml2js'),
	CheckOut = require('./lib/check-out.js'),
	Polling = require('./lib/polling.js'),
	OrderProcessing = require('./lib/order-processing.js'),
	OrderReporting = require('./lib/order-reporting.js')
